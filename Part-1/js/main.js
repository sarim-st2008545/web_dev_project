...
document.querySelector(".women_sweatshirt").addEventListener("click", function (event) {
    event.preventDefault();
    var searchQuery = "sweatshirt";
    localStorage.setItem("searchQuery", searchQuery);
...
document.querySelector(".women_accessories").addEventListener("click", function (event) {
    event.preventDefault();
    var searchQuery = "accessories";
    localStorage.setItem("searchQuery", searchQuery);
